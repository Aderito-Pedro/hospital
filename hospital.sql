...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Jan-2022 às 11:26
-- Versão do servidor: 10.4.21-MariaDB-log
...
--
-- Estrutura da tabela `alloted_bed`
--
...
(20, 'General Ward', 'CM12', 'Cama', NULL, NULL, NULL, 'General Ward-CM12', '416');

-- --------------------------------------------------------

--
-- Estrutura da tabela `bed_category`
--
...
--
-- Extraindo dados da tabela `bed_category`
--
...
INSERT INTO `convenio` (`id`, `descricao`, `responsavel`, `email`, `telefone`) VALUES
(1, 'BAI Seguro', 'Ermenegildo António', 'osorioferreira95@gmail.com', '912881721'),
(2, 'Sonangol', 'Pedro Agostinho', 'hpangola@hotmail.com', '995444432');
...
--
-- Estrutura da tabela `pacient_convenio`
--

CREATE TABLE `pacient_convenio` (
  `id` int(100) NOT NULL,
  `valor` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `id_paciente` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `id_convenio` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `estado` varchar(100) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `pacient_convenio`
--

INSERT INTO `pacient_convenio` (`id`, `valor`, `id_paciente`, `id_convenio`, `estado`) VALUES
(2, '24800', '33', '1', '1'),
(4, '100000', '33', '2', '1'),
(5, '225000', '37', '2', '1');
...
(37, 'uploads/empresa4.PNG', 'Adérito Pedro', 'aderitopescoco@gmail.com', '149', 'Luanda', '912127534', 'Male', '18-11-2021', NULL, 'B-', '760', '402649', '11/29/21', '1638194113', NULL, '416');
...
--
-- Extraindo dados da tabela `patient_deposit`
--
...
(1594, '33', '2021', '1638175555', '100', '2021.gp', 'Cash', NULL, '756', '416'),
(1595, '33', '2022', '1638185879', '100', '2022.gp', 'Cash', NULL, '756', '416'),
(1596, '33', '2023', '1638187736', '100', '2023.gp', 'Cash', NULL, '756', '416'),
(1597, '33', '2024', '1638187776', '100', '2024.gp', 'Cash', NULL, '756', '416'),
(1598, '33', '2025', '1638193918', '100', '2025.gp', 'Cash', NULL, '756', '416'),
(1599, '37', '2026', '1638194226', '100', '2026.gp', 'Cash', NULL, '756', '416'),
(1600, '33', '2027', '1638194300', '', '2027.gp', 'Cash', NULL, '756', '416');
...
(2021, NULL, '33', '149', '1638175555', '100', '0', NULL, NULL, '1', '1', '99', 'bem', '90', '9', NULL, '128*100*diagnostic*1', '100', 'Cash', 'unpaid', '756', 'Mr Patient', '+0123456789', 'Florida', 'Mr Doctor', '29-11-21', '416'),
(2022, NULL, '33', '', '1638185879', '100', '0', NULL, NULL, '6', '6', '94', 'ba', '94', '0', NULL, '128*100*diagnostic*1', '100', 'Cash', 'unpaid', '756', 'Mr Patient', '+0123456789', 'Florida', '0', '29-11-21', '416'),
(2023, NULL, '33', '', '1638187736', '100', '0', NULL, NULL, '45', '45', '55', 'Boa', '55', '0', NULL, '128*100*diagnostic*1', '100', 'Cash', 'unpaid', '756', 'Mr Patient', '+0123456789', 'Florida', '0', '29-11-21', '416'),
(2024, NULL, '33', '149', '1638187776', '100', '0', NULL, NULL, '0', '0', '100', 'A Compra foi confirmada', '90', '10', NULL, '128*100*diagnostic*1', '100', 'Cash', 'unpaid', '756', 'Mr Patient', '+0123456789', 'Florida', 'Mr Doctor', '29-11-21', '416'),
(2025, NULL, '33', '', '1638193918', '100', '0', NULL, NULL, '0', '0', '100', 'A Compra foi confirmada', '100', '0', NULL, '128*100*diagnostic*1', '100', 'Cash', 'unpaid', '756', 'Mr Patient', '+0123456789', 'Florida', '0', '29-11-21', '416'),
(2026, NULL, '37', '', '1638194226', '100', '0', NULL, NULL, '1', '1', '99', 'A Compra foi confirmada', '99', '0', NULL, '128*100*diagnostic*1', '100', 'Cash', 'unpaid', '756', 'Adérito Pedro', '912127534', 'Luanda', '0', '29-11-21', '416'),
(2027, NULL, '33', '', '1638194300', '100', '0', NULL, NULL, '0', '0', '100', '', '100', '0', NULL, '128*100*diagnostic*1', '', 'Cash', 'unpaid', '756', 'Mr Patient', '+0123456789', 'Florida', '0', '29-11-21', '416');
...
--
-- Extraindo dados da tabela `payment_category`
--
...
(3, 'Hospital management System', 'Hospital', 'Colegepara, Rajbari', '+0123456789', 'admin@hms.com', '', '$', 'portuguese', 'flat', '', '', '', '', 'PayPal', '', '', '', '416'),
...
(2, '127.0.0.1', 'Hospital', '$2y$08$nxWYs4Sc9VN6czyUtnJRwuMaflhMRZSV33GESf5zi8rjXGfaSHVlu', NULL, 'admin@hms.com', NULL, NULL, NULL, NULL, 1268889832, 1643214784, 1, 'admin', NULL, NULL, NULL, ''),
...
(756, '110.76.129.146', 'Mr Receptionist', '$2y$08$QGdhZzdJE3Wz76yBlRlLmew.7GimX8MBel8JQiyR8u3uIUQpqTt.m', NULL, 'receptionist@hms.com', NULL, NULL, NULL, NULL, 1562482561, 1638196050, 1, NULL, NULL, NULL, NULL, '2'),
(760, '::1', 'Adérito Pedro', '$2y$08$4hZ52rxq3/GHvRCG4v4oB.G9Loog2UYezP/PoJ01fa70LgnU5P0fK', NULL, 'aderitopescoco@gmail.com', NULL, NULL, NULL, NULL, 1638194113, NULL, 1, NULL, NULL, NULL, NULL, '2');
...
--
-- Índices para tabela `alloted_bed`
--
...
--
-- Índices para tabela `bed_category`
--
...
--
-- Índices para tabela `pacient_convenio`
--
ALTER TABLE `pacient_convenio`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pc` (`id_paciente`),
  ADD KEY `fk_cp` (`id_convenio`);
...
--
-- AUTO_INCREMENT de tabela `alloted_bed`
--
ALTER TABLE `alloted_bed`
...
--
-- AUTO_INCREMENT de tabela `bed`
--
ALTER TABLE `bed`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de tabela `bed_category`
--
ALTER TABLE `bed_category`
...
--
-- AUTO_INCREMENT de tabela `donor`
--
ALTER TABLE `donor`
...
--
-- AUTO_INCREMENT de tabela `pacient_convenio`
--
ALTER TABLE `pacient_convenio`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `payment`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2028;
