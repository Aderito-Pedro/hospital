...
class Notice extends MX_Controller {
    ...
    public function salvar(){
        $descricao = $this->input->post('value_convenio');
        $responsavel = $this->input->post('value_responsavel');
        $email = $this->input->post('value_cemail');
        $telefone = $this->input->post('value_telefone');
        ...
        $this->notice_model->insertConvenio($data);
