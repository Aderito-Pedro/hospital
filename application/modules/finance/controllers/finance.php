...
class Finance extends MX_Controller {
    ...
    public function verificaSeConvenio(){
        $id = $this->input->get('id');
        $data = $this->patient_model->seConvenio($id);
        if(empty($data)) echo json_encode(false);
    ...
    public function addPayment() {
        ...
        $formaPagamento = $this->input->post('value_pagamento_tipo');
        ...
        if($formaPagamento == 1){
            $this->patient_model->reduzirvalor($amount_received,$patient);
        }
