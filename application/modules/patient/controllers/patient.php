...
class Patient extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $data['convenios'] = $this->patient_model->getConvenio();
        $data['pacientes'] = $this->patient_model->getPatient();
    ...
    {
        $valor = $this->input->post('value_valor');
        $id_paciente = $this->input->post('value_paciente');
        $id_convenio = $this->input->post('value_convenio');
        ...
        $this->patient_model->insertPacienteConvenio($data);
