        ...
        <section class="">
            ...
            <header class="panel-heading">
                ...
                <div class="col-md-4 no-print pull-right">
                    <button type="button" class="btn green btn-xs" data-toggle="modal" data-target="#modalExemplo">
                        Associar Convénio
                    </button>
...
<div class="modal fade" id="modalExemplo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Associar Convénio</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="patient/addConvenio">
                <div class="row-md-12">
                    <div class="col-5">
                        <label for="exampleInputEmail1" class="pt-2">Associar Um Convénio</label>
                        <select class="form-control js-example-basic-single doctor" name="value_convenio" value=''>
                            <option value=""> </option>
                            <?php foreach ($convenios as $convenio) { ?>
                                <option value="<?php echo $convenio->id; 
                                                ?>"><?php echo $convenio->descricao; ?> </option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-5">
                    <label for="exampleInputEmail1" class="pt-2">Associar Um Convénio</label>
                        <select class="form-control js-example-basic-single doctor" name="value_paciente" value=''>
                            <option value=""> </option>
                            <?php foreach ($pacientes as $paciente) { ?>
                                <option value="<?php echo $paciente->id; 
                                                ?>"><?php echo $paciente->name; ?> </option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Valor</label>
                        <input type="text" class="form-control" placeholder="Informe o valor aqui" name="value_valor" value=''>
                        <small class="form-text text-muted">Informe o valor Inicial para o paciente escolhido.</small>
                    </div>
                </div>
