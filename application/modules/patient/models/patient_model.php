...
class Patient_model extends CI_model {
    ...
    function insertPacienteConvenio($data){
        $this->db->insert('pacient_convenio', $data);
    }
    ...
    function reduzirvalor($valor,$id_paciente){
        $query = $this->db->select('valor ')
        ->from('pacient_convenio')
        ...
        $valor = $valors->valor -  $valor;
        $data = array(
            'valor' => $valor
        );
        $this->db->where('id_paciente', $id_paciente);
        $this->db->update('pacient_convenio',  $data);  
    }
    ...
    function seConvenio($id_paciente){
        $query = $this->db->select('pacient_convenio.id,valor,descricao')
                ->from('pacient_convenio,convenio')
                ->where("(id_paciente = ".$id_paciente." and pacient_convenio.id_convenio = convenio.id)")
                ->get();
