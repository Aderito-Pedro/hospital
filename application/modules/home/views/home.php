                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                        ...
                                        <div class="task-content panel">
                                            ...
                                            <div class="panel col-md-12 add-task-row">
                                                <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                                    ...
                                                    <button type="button" class="btn btn-success btn-sm pull-left ml-3" data-toggle="modal" data-target="#ModalLongoExemplo">Adicionar Convénio</button>
                                                <?php } ?>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="TituloModalLongoExemplo">Registar Convénio</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                            <form method="post" action="<?php echo base_url('notice/salvar') ?>">
                                <div class="form-group">
                                    <label for="exampleInputconvenio">Convénio</label>
                                    <input type="text" class="form-control" id="value_convenio" name="value_convenio" aria-describedby="conveniolHelp" placeholder="Informe o convénio">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputcemail">Email</label>
                                    <input type="email" class="form-control" id="value_cemail" name="value_cemail" aria-describedby="cemaillHelp" placeholder="Informe o email">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputtelefone">Telefone</label>
                                    <input type="text" class="form-control" id="value_telefone" name="value_telefone" aria-describedby="telefonelHelp" placeholder="Informe o telefone">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Responsável</label>
                                    <input type="text" class="form-control" name="value_responsavel" id="value_responsavel" placeholder="Responsável">
                                </div>
